...
int main()
{
    ...
    mknod("/home/maxim/Documents/Projects/fifo", S_IFIFO | 0666, 0);//заводится файл-метка
    printf("FIFO создан...\n");
	...
	fd = open("/home/maxim/Documents/Projects/fifo", O_WRONLY);//-1 ошибка или дескриптор
