...
int main(){
    printf("Лаб.раб.4.5.Выполнила студентка группы ИСТбд-21 Ахвандеева О.С.\n");
	int fd;
	char str[]= "Hi!";
    printf("Запись информации в FIFO...\n");
    //создания FIFO используется системный вызов mknod
    printf("Начало создания FIFO...\n");
    mknod("/home/student/new/fifo", S_IFIFO | 0666, 0);//заводится файл-метка
    printf("FIFO создан...\n");
	...
	fd = open("/home/student/new/fifo", O_WRONLY);//-1 ошибка или дескриптор
