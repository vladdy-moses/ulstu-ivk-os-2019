...
int main()
{
    printf("Лабораторная работа №4 Задание 2 WP\n\
Выполнил студент ИСТбд-21 Цыпленков Д. А.\n");
    ...
    mknod("/home/denis/file/file2.fifo", S_IFIFO | 0666, 0);//заводится файл-метка
    printf("FIFO создан...\n");
	...
	fd = open("/home/denis/file/file2.fifo", O_WRONLY);//-1 ошибка или дескриптор
